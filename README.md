...
<style>
  ...
  #starsCanvas { position: fixed; top:0; left:0; width:100%; height:100%; z-index:-2; }
  .aurora { position: fixed; top:0; left:0; width:100%; height:100%;
    background: radial-gradient(circle at 50% 50%, rgba(255,255,255,0.05), transparent 70%),
                linear-gradient(135deg, rgba(0,255,255,0.15), rgba(255,0,255,0.15));
    mix-blend-mode: screen; animation: auroraMove 15s ease-in-out infinite alternate; z-index:-1; }
  @keyframes auroraMove { 0%{transform:translateY(0) scale(1);} 100%{transform:translateY(-50px) scale(1.1);} }

  h1 { font-size:48px; margin:24px 0 8px; font-weight:900; letter-spacing:2px;
       text-shadow:0 0 12px #fff,0 0 24px #ff00ff,0 0 36px #00ffff; }
  ...
  .settings { position:fixed; top:50px; right:15px; background:#222; padding:15px; border-radius:8px;
              display:none; box-shadow:0 0 10px rgba(0,0,0,0.5); z-index:10000; }
  .settings input { padding:8px; width:250px; border-radius:5px; border:none; margin-bottom:10px; }
  .settings p { font-size:13px; color:#aaa; margin:0; }

  #searchBar,.primary { width:var(--btn-w); padding:var(--btn-pad); font-size:20px; border-radius:12px; margin:12px auto; display:block; }
  ...
  .primary { border:none; cursor:pointer; color:#fff; background:linear-gradient(135deg,#24c6dc,#514a9d);
             box-shadow:0 6px 16px rgba(0,0,0,0.35); transition:transform .15s ease, filter .2s ease; }
  ...
  #loginOverlay p { font-size: 13px; color: #ccc; margin-top: 8px; }
</style>
</head>
<body>
...
<div id="gameCounter">Games 280</div>
...
<div id="buttonContainer">
   <button data-url="https://dddavit.github.io/subway/">   <span class="label">Subway Surfers</span><span class="fav-star">☆</span> </button>
    ...
    <button data-url="https://geography-lessons.github.io/Vafor_IT/precision-client/precision-client-v34.6/public/">   <span class="label">Minecraft/Eaglecraft</span><span class="fav-star">☆</span> </button>
...
<script>
  ...
  function initLauncher() {
    ...
    // Handle game button clicks (supports data-game and data-url)
